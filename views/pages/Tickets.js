...
let Tickets = {
      render: async () => {
        let request = Utils.parseRequestURL().id
        let ticketId = request.match( /\d+/ )
        let filmName = request.match( /\D+/ )
              ...
              <div style="max-width: 1200px; margin: 0 auto; padding: 10px;">
                <div class="container-fluid">
                  <table style="width:100%">
                    <tr class="row border">
                      <th class="col-md-2 border">Movie</th>
                      <th class="col-md-2 border">Time</th>
                      <th class="col-md-2 border">Tickets</th>
                      <th class="col-md-3 border">Cost</th>
                      <th class="col-md-3 border">Total</th>
                    </tr>
                    <tr class="row border">
                      <td class="col-md-2 border">${filmName}</td>
                      <td class="col-md-2 border">${ticketId}</td>
                      <td class="col-md-2 border">
                        <input type="number" class="form-control" id="fieldname" placeholder="0" value="0">
                      </td>
                      <td id="singleTicket" class="col-md-3 border" align="right">38 Kn</td>
                      <td class="col-md-3 border" align="right"></td>
                    </tr>
                    <tr class="row border">
                      <td class="col-md-9 border">Total</td>
                      <td id="totalCost" class="col-md-3 border" align="right">0kn</td>
                    </tr>
                  </table>
                  ...
                  <div class="col-md-1 text"><a class="btn btn-primary btn-lg">Checkout</a></div>
                </div>
              </div>
            </section>
        `}
         ,after_render: async () => {
          $('input').change(function(){
            var s = $('#singleTicket').text().match( /\d+/ );
            $('#totalCost').text((Number(s)*Number($(this).val())) + 'kn');
          });
